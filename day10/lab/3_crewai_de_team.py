...
""")
    ...
    incident_reporter = Agent(
        ...
        goal="Condense complex data quality reports into a 6-line slack message",
        backstory="""You are an operations lead who hates reading long reports.
        You were recently reprimanded for sending 500-word emails when a simple
        alert would suffice. You are now ruthlessly concise and only provide exactly
        what is asked.""",
        llm=llm_lite,
        verbose=True,
        allow_delegation=False,
